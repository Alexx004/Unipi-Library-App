...
public class PendingFinesListSceneCreator extends SceneCreator{

	private Stage stage;
	private Runnable onCancel;
	private LoanManager loanManager;
	
	public PendingFinesListSceneCreator(Stage stage, double width, double height, Runnable onCancel, LoanManager loanManager) {
		super(width, height);
		this.stage = stage;
	...
	public Scene createScene() {
		Text unpaidFinesTxt = new Text("Unpaid Fines"); //epikefalida
	    ...
	    TableColumn<Fine, String> amountCol = new TableColumn<>("Amount"); //Sthlh me to poso tou prostimou 
         ...
         tableView.setItems(FXCollections.observableArrayList(loanManager.getUnpaidFines()));
